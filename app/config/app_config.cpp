...
QString GlobalConfig::key(opt::GlobalOptions o)
{
  switch (o) {
    ...
    case opt::ScreenEdgeDistance:       return "behavior/screen_edge_distance";
...
QVariant GlobalConfig::def_value(opt::GlobalOptions o)
{
  switch (o) {
    ...
    case opt::ScreenEdgeDistance:       return 0;
...
QVariant InstanceConfig::def_value(opt::InstanceOptions o)
{
  switch (o) {
    ...
    case opt::CharMargins:              return QVariant::fromValue(QMarginsF(0.5, 0.5, 0.5, 0.5));
    case opt::WidgetMargins:            return QVariant::fromValue(QMarginsF(4.0, 4.0, 4.0, 4.0));
